 ...
 * generated in the fr.m2i.crm.soap.service.customer.generated package. 
...
public class ObjectFactory {
    ...
    private final static QName _CreateCustomer_QNAME = new QName("http://m2i/crm/soap", "CreateCustomer");
    private final static QName _CreatedCustomerId_QNAME = new QName("http://m2i/crm/soap", "CreatedCustomerId");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: fr.m2i.crm.soap.service.customer.generated
     * 
     */
     ...
     *     Java instance representing xml element's value.
     * @return
     *     the new instance of {@link JAXBElement }{@code <}{@link CustomerWrapper }{@code >}
     */
    @XmlElementDecl(namespace = "http://m2i/crm/soap", name = "CreateCustomer")
    public JAXBElement<CustomerWrapper> createCreateCustomer(CustomerWrapper value) {
        return new JAXBElement<CustomerWrapper>(_CreateCustomer_QNAME, CustomerWrapper.class, null, value);
    }
     ...
     *     the new instance of {@link JAXBElement }{@code <}{@link CustomerIdWrapper }{@code >}
     */
    @XmlElementDecl(namespace = "http://m2i/crm/soap", name = "CreatedCustomerId")
    public JAXBElement<CustomerIdWrapper> createCreatedCustomerId(CustomerIdWrapper value) {
        return new JAXBElement<CustomerIdWrapper>(_CreatedCustomerId_QNAME, CustomerIdWrapper.class, null, value);
    }
