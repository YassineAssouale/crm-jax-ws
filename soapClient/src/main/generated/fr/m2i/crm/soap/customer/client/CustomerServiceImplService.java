 ...
 * 
 */
@WebServiceClient(name = "CustomerServiceImplService", targetNamespace = "http://impl.customer.service.soap.crm.m2i.fr/", wsdlLocation = "http://localhost:9990/CustomerService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CUSTOMERSERVICEIMPLSERVICE_QNAME = new QName("http://impl.customer.service.soap.crm.m2i.fr/", "CustomerServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9990/CustomerService?wsdl");
    ...
    public CustomerService getCustomerServiceImplPort() {
        return super.getPort(new QName("http://impl.customer.service.soap.crm.m2i.fr/", "CustomerServiceImplPort"), CustomerService.class);
    }
    ...
    public CustomerService getCustomerServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.customer.service.soap.crm.m2i.fr/", "CustomerServiceImplPort"), CustomerService.class, features);
    }
